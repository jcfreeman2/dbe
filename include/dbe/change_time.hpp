...
{
public:
  ChangeTime ( tref Object, dunedaq::oksdbinterfaces::attribute_t AttributeData, T NewValueData,
...
template<typename T>
ChangeTime<T>::ChangeTime ( tref Object, dunedaq::oksdbinterfaces::attribute_t AttributeData,
